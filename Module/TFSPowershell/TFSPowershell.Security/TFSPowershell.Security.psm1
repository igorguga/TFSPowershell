...
# .ExternalHelp TFSPowershell.Security.psm1-Help.xml
Function Set-AreaPermissions
{
    ...
    Param (
        ...
        [Parameter(mandatory=$true, HelpMessage ="Usuários ou grupos para conceder a permissão.")]
        [string []] $Members,
...
Function Set-SourceControlPermissions
{
    ...
    Param (
        ...
        [Parameter(mandatory=$true, HelpMessage ="Indicar se o parâmetro membros constitui-se de Grupos ou Usuários.")]
...
Function Set-BuildDefinitionPermissions
{
    ...
    End
    {
        ...
        if ($build -eq $null)
        {
            Write-Error "Build definition $BuildDefinitionName não encontrado no team project $TeamProjectName."
            return
        }
